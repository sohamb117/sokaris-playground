 ...
 * @returns {any}
 */
export function compile_to_wasm(source, options) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_to_wasm(ptr0, len0, isLikeNone(options) ? 0 : addToExternrefTable0(options));
    return ret;
}
 ...
 * @returns {any}
 */
export function run_from_source_with_image(source, seed, name, width, height, rgba) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.run_from_source_with_image(ptr0, len0, seed, ptr1, len1, width, height, ptr2, len2);
    return ret;
}
