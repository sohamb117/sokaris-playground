...
export const __wbg_registervmbench_free: (a: number, b: number) => void;
...
export const registervmbench_new: (a: number, b: number) => [number, number, number];
export const registervmbench_run: (a: number, b: number, c: number, d: bigint) => [number, number, number];
export const run_from_source: (a: number, b: number, c: bigint) => any;
export const run_from_source_typed: (a: number, b: number, c: bigint) => any;
export const run_from_source_with_image: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number, h: number, i: number) => any;
...
export const compile_to_wasm: (a: number, b: number, c: number) => any;
